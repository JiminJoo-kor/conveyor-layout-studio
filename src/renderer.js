  ...
  drawCadFlow(state){
    ...
    if(state.cadTokens){
      ...
      for(const token of state.cadTokens){
        ...
        let point,cargoW=metrics.visualLength,cargoH=metrics.visualWidth;
        ...
        else if(!token.edge)point={x:fromNode.x,y:fromNode.y};
