...
export class LayoutEditor {
  ...
  pointerDown(event){const p=this.worldPoint(event),hit=this.hit(p);
    ...
    if(this.placementType){const item=this.addAt(this.placementType,p);this.placementType=null;this.canvas.classList.remove('placing');this.renderer.setPlacementPreview(null,null);this.setConnectionMode(true,item.id);return;}
