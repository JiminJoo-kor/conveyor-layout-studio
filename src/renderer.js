  ...
  drawCadFlow(state){
    ...
    if(state.cadTokens){
      ...
      for(const token of state.cadTokens){
        ...
        else if(!token.edge){point=equipmentCargoVisualPose(this.layout,fromNode,state,token,cargoW,this.layout.cadViewMode==='hybrid'?58:78);cargoAngle=point.angle;clipItem=fromNode;}
